...
- [Discovery Agent Frontend Architecture](#table-of-contents)
  - [Template & Framework Selection](./template-framework-selection.md)
    - [Change Log](./template-framework-selection.md#change-log)
  ...
  - [Styling Guidelines](./styling-guidelines.md)
    - [Theme Tokens](./styling-guidelines.md#theme-tokens)
  - [Testing Requirements](./testing-requirements.md)
  - [Environment & Feature Flags](./environment-feature-flags.md)
