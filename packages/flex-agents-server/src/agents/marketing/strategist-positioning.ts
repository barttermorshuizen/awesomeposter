...
const INPUT_FACETS = ['positioning_context', 'feedback'] as const
...
export const STRATEGIST_POSITIONING_INSTRUCTIONS_APP = [
  ...
  'Review positioning_context and feedback to understand market landscape before generating updates.',
  ...
  'While blocked on human input, populate output facets with placeholders that describe the outstanding decision.'
].join('\n')
...
export const STRATEGIST_POSITIONING_CAPABILITY: CapabilityRegistration = {
  ...
  inputTraits: {
    ...
    limitations: ['Needs positioning context and prior feedback to operate effectively.']
  },
  inputContract: {
    mode: 'facets',
    facets: [...INPUT_FACETS]
