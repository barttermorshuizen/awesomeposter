...
export const CONTENT_INSTRUCTIONS_APP = [
  ...
  HITL_ENABLED
    ? [
        ...
        'When you invoke `hitl_request`, ensure the `question` field clearly states the decision the operator must make and provide the context the operator needs for a quick response.',
