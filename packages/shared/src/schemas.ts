...
export type CreateBriefSchema = z.infer<typeof createBriefSchema>
...
export const createOrUpdateClientProfileSchema = z.object({
...
export type CreateOrUpdateClientProfileSchema = z.infer<typeof createOrUpdateClientProfileSchema>
