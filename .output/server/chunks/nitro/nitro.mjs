...
const _X5mvMM = eventHandler((event) => {
...
const _HBxCsC = defineEventHandler((event) => {
...
const _QcA2i1 = defineEventHandler((event) => {
  if (process.env.LOG_REQUESTS !== "1") return;
  try {
    const url = getRequestURL(event);
    const path = (url == null ? void 0 : url.pathname) || "";
...
const _lazy_ajevMU = () => import('../routes/api/agent/critique-revise.post.mjs');
const _lazy_4rIIhZ = () => import('../routes/api/agent/execute-workflow-progress.post.mjs');
const _lazy_5VDY5I = () => import('../routes/api/agent/execute-workflow.post.mjs');
const _lazy_U5Lpv7 = () => import('../routes/api/agent/finalize.post.mjs');
const _lazy_0q7a1_ = () => import('../routes/api/agent/plan-strategy.post.mjs');
const _lazy_ONHbzK = () => import('../routes/api/agent/workflow-status.get.mjs');
const _lazy_zCG0yq = () => import('../routes/api/agent/write-drafts.post.mjs');
const _lazy_AmWwTH = () => import('../routes/api/assets/_id/download.get.mjs');
const _lazy_PkCcpZ = () => import('../routes/api/assets/index.delete.mjs');
const _lazy_8eS_3u = () => import('../routes/api/assets/index.patch.mjs');
const _lazy_SrDijS = () => import('../routes/api/index.get.mjs');
const _lazy_eeo4af = () => import('../routes/api/index.post.mjs');
const _lazy_wEIVwa = () => import('../routes/api/assets/upload.post.mjs');
const _lazy_PtVk_P = () => import('../routes/api/briefs/_id/approve.post.mjs');
const _lazy_W5TWoX = () => import('../routes/api/briefs/_id/assets.get.mjs');
const _lazy_VsSuyA = () => import('../routes/api/briefs/index.delete.mjs');
const _lazy_ayilrz = () => import('../routes/api/briefs/index.get.mjs');
const _lazy_u4lZN5 = () => import('../routes/api/briefs/index.patch.mjs');
const _lazy_DXsqBd = () => import('../routes/api/briefs/_id/send-to-agent.post.mjs');
const _lazy_ipY2bS = () => import('../routes/api/index.get2.mjs');
const _lazy_lUdseG = () => import('../routes/api/index.post2.mjs');
const _lazy_C7v32K = () => import('../routes/api/clients/_id/feature-flags.get.mjs');
const _lazy_VHAXVR = () => import('../routes/api/clients/_id/feature-flags.patch.mjs');
const _lazy_4a685Y = () => import('../routes/api/clients/index.delete.mjs');
const _lazy_EYhXdb = () => import('../routes/api/clients/index.get.mjs');
const _lazy_aRfnZv = () => import('../routes/api/clients/_id/keywords/_keywordId_.delete.mjs');
const _lazy__55tX9 = () => import('../routes/api/clients/_id/keywords/_keywordId_.patch.mjs');
const _lazy_5oVUaK = () => import('../routes/api/clients/_id/index.get.mjs');
const _lazy_QUp_RL = () => import('../routes/api/clients/_id/index.post.mjs');
const _lazy_dZRcC0 = () => import('../routes/api/clients/_id/profile.get.mjs');
const _lazy_AdxYyX = () => import('../routes/api/clients/_id/profile.patch.mjs');
const _lazy_nV59iK = () => import('../routes/api/clients/_id/sources/_sourceId_.delete.mjs');
const _lazy_qUU1Xm = () => import('../routes/api/clients/_id/index.get2.mjs');
const _lazy__11lBh = () => import('../routes/api/clients/_id/index.post2.mjs');
const _lazy_PQ2C2P = () => import('../routes/api/index.get3.mjs');
const _lazy_KzCEAF = () => import('../routes/api/index.post3.mjs');
const _lazy_DohWaV = () => import('../routes/api/clients/update-client.patch.mjs');
const _lazy_HGX2bD = () => import('../routes/api/discovery/events.stream.mjs');
const _lazy_0SaLJY = () => import('../routes/api/discovery/search.get.mjs');
const _lazy_WSMcMc = () => import('../routes/api/events/discovery.get.mjs');
const _lazy_2ZaLGQ = () => import('../routes/api/generate-variants.post.mjs');
const _lazy_GWiFqD = () => import('../routes/api/health.get.mjs');
const _lazy_JjYWs_ = () => import('../routes/api/hitl/pending.get.mjs');
const _lazy_2ND2CY = () => import('../routes/api/hitl/remove.post.mjs');
const _lazy_6EfkfT = () => import('../routes/api/hitl/resume.post.mjs');
const _lazy_yZHMyE = () => import('../routes/api/inbound/mailgun.post.mjs');
const _lazy_iE3mf8 = () => import('../routes/api/rank-variants.post.mjs');
const _lazy_1uMaf6 = () => import('../routes/api/retrieve-winners.post.mjs');
const _lazy_my_eF_ = () => import('../routes/api/tasks/_id/complete.post.mjs');
const _lazy_9vPstJ = () => import('../routes/api/index.get4.mjs');
const _lazy_OlQoaq = () => import('../routes/api/test-client-profile.get.mjs');

const handlers = [
  { route: '', handler: _X5mvMM, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _HBxCsC, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _QcA2i1, lazy: false, middleware: true, method: undefined },
  { route: '/api/agent/critique-revise', handler: _lazy_ajevMU, lazy: true, middleware: false, method: "post" },
  { route: '/api/agent/execute-workflow-progress', handler: _lazy_4rIIhZ, lazy: true, middleware: false, method: "post" },
  { route: '/api/agent/execute-workflow', handler: _lazy_5VDY5I, lazy: true, middleware: false, method: "post" },
  { route: '/api/agent/finalize', handler: _lazy_U5Lpv7, lazy: true, middleware: false, method: "post" },
  { route: '/api/agent/plan-strategy', handler: _lazy_0q7a1_, lazy: true, middleware: false, method: "post" },
  { route: '/api/agent/workflow-status', handler: _lazy_ONHbzK, lazy: true, middleware: false, method: "get" },
  { route: '/api/agent/write-drafts', handler: _lazy_zCG0yq, lazy: true, middleware: false, method: "post" },
  { route: '/api/assets/:id/download', handler: _lazy_AmWwTH, lazy: true, middleware: false, method: "get" },
  { route: '/api/assets/:id', handler: _lazy_PkCcpZ, lazy: true, middleware: false, method: "delete" },
  { route: '/api/assets/:id', handler: _lazy_8eS_3u, lazy: true, middleware: false, method: "patch" },
  { route: '/api/assets', handler: _lazy_SrDijS, lazy: true, middleware: false, method: "get" },
  { route: '/api/assets', handler: _lazy_eeo4af, lazy: true, middleware: false, method: "post" },
  { route: '/api/assets/upload', handler: _lazy_wEIVwa, lazy: true, middleware: false, method: "post" },
  { route: '/api/briefs/:id/approve', handler: _lazy_PtVk_P, lazy: true, middleware: false, method: "post" },
  { route: '/api/briefs/:id/assets', handler: _lazy_W5TWoX, lazy: true, middleware: false, method: "get" },
  { route: '/api/briefs/:id', handler: _lazy_VsSuyA, lazy: true, middleware: false, method: "delete" },
  { route: '/api/briefs/:id', handler: _lazy_ayilrz, lazy: true, middleware: false, method: "get" },
  { route: '/api/briefs/:id', handler: _lazy_u4lZN5, lazy: true, middleware: false, method: "patch" },
  { route: '/api/briefs/:id/send-to-agent', handler: _lazy_DXsqBd, lazy: true, middleware: false, method: "post" },
  { route: '/api/briefs', handler: _lazy_ipY2bS, lazy: true, middleware: false, method: "get" },
  { route: '/api/briefs', handler: _lazy_lUdseG, lazy: true, middleware: false, method: "post" },
  { route: '/api/clients/:id/feature-flags', handler: _lazy_C7v32K, lazy: true, middleware: false, method: "get" },
  { route: '/api/clients/:id/feature-flags', handler: _lazy_VHAXVR, lazy: true, middleware: false, method: "patch" },
  { route: '/api/clients/:id', handler: _lazy_4a685Y, lazy: true, middleware: false, method: "delete" },
  { route: '/api/clients/:id', handler: _lazy_EYhXdb, lazy: true, middleware: false, method: "get" },
  { route: '/api/clients/:id/keywords/:keywordId', handler: _lazy_aRfnZv, lazy: true, middleware: false, method: "delete" },
  { route: '/api/clients/:id/keywords/:keywordId', handler: _lazy__55tX9, lazy: true, middleware: false, method: "patch" },
  { route: '/api/clients/:id/keywords', handler: _lazy_5oVUaK, lazy: true, middleware: false, method: "get" },
  { route: '/api/clients/:id/keywords', handler: _lazy_QUp_RL, lazy: true, middleware: false, method: "post" },
  { route: '/api/clients/:id/profile', handler: _lazy_dZRcC0, lazy: true, middleware: false, method: "get" },
  { route: '/api/clients/:id/profile', handler: _lazy_AdxYyX, lazy: true, middleware: false, method: "patch" },
  { route: '/api/clients/:id/sources/:sourceId', handler: _lazy_nV59iK, lazy: true, middleware: false, method: "delete" },
  { route: '/api/clients/:id/sources', handler: _lazy_qUU1Xm, lazy: true, middleware: false, method: "get" },
  { route: '/api/clients/:id/sources', handler: _lazy__11lBh, lazy: true, middleware: false, method: "post" },
  { route: '/api/clients', handler: _lazy_PQ2C2P, lazy: true, middleware: false, method: "get" },
  { route: '/api/clients', handler: _lazy_KzCEAF, lazy: true, middleware: false, method: "post" },
  { route: '/api/clients/update-client', handler: _lazy_DohWaV, lazy: true, middleware: false, method: "patch" },
  { route: '/api/discovery/events.stream', handler: _lazy_HGX2bD, lazy: true, middleware: false, method: undefined },
  { route: '/api/discovery/search', handler: _lazy_0SaLJY, lazy: true, middleware: false, method: "get" },
  { route: '/api/events/discovery', handler: _lazy_WSMcMc, lazy: true, middleware: false, method: "get" },
  { route: '/api/generate-variants', handler: _lazy_2ZaLGQ, lazy: true, middleware: false, method: "post" },
  { route: '/api/health', handler: _lazy_GWiFqD, lazy: true, middleware: false, method: "get" },
  { route: '/api/hitl/pending', handler: _lazy_JjYWs_, lazy: true, middleware: false, method: "get" },
  { route: '/api/hitl/remove', handler: _lazy_2ND2CY, lazy: true, middleware: false, method: "post" },
  { route: '/api/hitl/resume', handler: _lazy_6EfkfT, lazy: true, middleware: false, method: "post" },
  { route: '/api/inbound/mailgun', handler: _lazy_yZHMyE, lazy: true, middleware: false, method: "post" },
  { route: '/api/rank-variants', handler: _lazy_iE3mf8, lazy: true, middleware: false, method: "post" },
  { route: '/api/retrieve-winners', handler: _lazy_1uMaf6, lazy: true, middleware: false, method: "post" },
  { route: '/api/tasks/:id/complete', handler: _lazy_my_eF_, lazy: true, middleware: false, method: "post" },
  { route: '/api/tasks', handler: _lazy_9vPstJ, lazy: true, middleware: false, method: "get" },
  { route: '/api/test-client-profile', handler: _lazy_OlQoaq, lazy: true, middleware: false, method: "get" }
];
...
const scheduledTasks = [{"cron":"*/5 * * * *","tasks":["discovery-ingestion"]},{"cron":"0 * * * *","tasks":["discovery-mark-stale"]}];
...
const tasks = {
  "discovery-ingestion": {
          ...
          resolve: () => import('../_/ingest-sources.mjs').then(r => r.default || r),
        },
"discovery-mark-stale": {
          meta: {
            description: "Mark stale discovery sources warning/error states",
          },
          resolve: () => import('../_/mark-stale-sources.mjs').then(r => r.default || r),
        }
};
